...
server_dict = {
    'mini':{
        ...
        'data_path': './dataset/miniImagenet/'
        },  
    'fs':{
        'dataset': 'fs',
        'dataset_name': 'cifar-fs',
        'data_path': './dataset/cifar_fs/'
        },
    'fc100':{
        'dataset': 'fc100',
        'dataset_name': 'FC100',
        'data_path': './dataset/FC100-84/'
        },
    'tiered':{
        'dataset': 'tiered',
        'dataset_name': 'tiered-imagenet',
        'data_path': './dataset/tieredImageNet/'
        },
}
...
#         'dataset': 'mini',
#         'dataset_name': 'mini-imagenet',
#         'data_path': '/home/zzy/FSOR-prompt/SemanticPrompt/dataset/miniImagenet/'
#         },  
#     'fs':{
#         'dataset': 'fs',
#         'dataset_name': 'cifar-fs',
#         'data_path': '/home/zzy/FSOR-prompt/SemanticPrompt/dataset/cifar100/'
#         },
#     'fc100':{
#         'dataset': 'fc100',
#         'dataset_name': 'FC100',
...
#         'dataset': 'tiered',
#         'dataset_name': 'tiered-imagenet',
#         'data_path': '/home/zzy/FSOR-prompt/SemanticPrompt/dataset/tieredImageNet/'
#         },
#     'cub':{
#         'dataset': 'cub',
#         'dataset_name': 'cub',
#         'data_path': '/home/zzy/GFNet/SMKD/CUB_200_2011/CUB_200_2011/dataset/'
#         },
# }
...
def eval_valtest(args):
    ...
    elif 'cifar' in dataset_name or 'FC100' in dataset_name or 'cub' in dataset_name:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Evaluation MICM')
    ...
    parser.add_argument('--batch_size_per_gpu', default=80, type=int, help='Per-GPU batch-size')
    ...
    # evaluation args
    parser.add_argument('--partition', default='novel', type=str) 
    ...
    parser.add_argument('--ckpt_filename', default='', type=str, help="checkpoint0018.pth")
